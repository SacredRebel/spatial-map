...
export class Hud {
  ...
  constructor(container: HTMLElement, o: HudOpts) {
    ...
    this.root.innerHTML = `
      <header class="hud-top">
        <div class="brand"><span class="mark">◈</span><b>${esc(o.community)}</b><span class="sub">walkable world · v0.8</span></div>
        <div class="acts">
  ...
  setMode(flying: boolean, editing: boolean) {
    ...
    this.q('[data-el="keys"]').innerHTML = editing
      ? 'click to select or place · drag a block to move it · <b>[ ]</b> turn · <b>1–9, 0</b> tools · <b>V</b> grid · <b>Enter</b> finish a line · <b>Esc</b> cancel · <b>Ctrl Z</b> undo · right-drag to look · <b>B</b> leave edit'
      : flying
